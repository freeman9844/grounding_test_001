...
Vertex AI 엔드포인트는 AI Studio와 달리 백엔드 API에서 검색 기간을 제한하는 `time_range_filter` 파라미터를 현재 제공하지 않습니다. 이 제약을 우회하여 완벽한 "최신성(Freshness)"을 보장하기 위해 본 프로젝트는 다음과 같은 아키텍처를 사용합니다.
